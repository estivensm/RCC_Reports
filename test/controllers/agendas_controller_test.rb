...
class AgendasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agenda" do
    assert_difference('Agenda.count') do
      post agendas_url, params: { agenda: { cargo: @agenda.cargo, celular: @agenda.celular, direccion_empresa: @agenda.direccion_empresa, email: @agenda.email, empresa: @agenda.empresa, nombre: @agenda.nombre, telefono: @agenda.telefono } }
    end
  ...
  test "should update agenda" do
    patch agenda_url(@agenda), params: { agenda: { cargo: @agenda.cargo, celular: @agenda.celular, direccion_empresa: @agenda.direccion_empresa, email: @agenda.email, empresa: @agenda.empresa, nombre: @agenda.nombre, telefono: @agenda.telefono } }

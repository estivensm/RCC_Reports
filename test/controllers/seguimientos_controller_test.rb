...
class SeguimientosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seguimiento" do
    assert_difference('Seguimiento.count') do
      post seguimientos_url, params: { seguimiento: { attachment: @seguimiento.attachment, description: @seguimiento.description, report_id: @seguimiento.report_id } }
    end
  ...
  test "should update seguimiento" do
    patch seguimiento_url(@seguimiento), params: { seguimiento: { attachment: @seguimiento.attachment, description: @seguimiento.description, report_id: @seguimiento.report_id } }

...
class ProductImagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_image" do
    assert_difference('ProductImage.count') do
      post product_images_url, params: { product_image: { description: @product_image.description, image: @product_image.image, number: @product_image.number, report_id: @product_image.report_id } }
    end
  ...
  test "should update product_image" do
    patch product_image_url(@product_image), params: { product_image: { description: @product_image.description, image: @product_image.image, number: @product_image.number, report_id: @product_image.report_id } }
